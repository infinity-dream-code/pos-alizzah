...
<div class="content-area">
    ...
    <h2 class="text-3xl font-bold text-slate-800 mb-6">Tambah Supplier</h2>
        ...
        <form action="{{ route('supplier.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="alamat" rows="3"
                          class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">{{ old('alamat') }}</textarea>
            </div>
